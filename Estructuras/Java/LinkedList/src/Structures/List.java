...
public interface List<T> {
     ...
     * @return boolean true
     */
    public boolean add(NodeI nodeI, T object);
     ...
     * @return boolean true
     */
    public boolean add(NodeI nodeI, T[] objects);
     ...
     * @return Object objeto
     */
    public T getPrevious(NodeI nodeI);
     ...
     * @return true
     */
    public boolean set(NodeI nodeI, T object);
